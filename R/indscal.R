...
# final normalisation:
  ...
  title(main = paste("Weight representation (","comp",coord[1],"-","comp",coord[2],")"))
  ...
  title(main = paste("Correlation (comp",coord[1],"-","comp",coord[2],")"))
  ...
  title(main = paste("Stimuli map (","comp",coord[1],"-","comp",coord[2],")"))
